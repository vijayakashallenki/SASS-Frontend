...
import registerpic from "../../assets/images/register.png";
...
const Register = () => {
  ...
  return (
    <div className="font-poppins max-w-screen">
              ...
              <div class="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px]">
                ...
                <form onSubmit={formik.handleSubmit}>
                  ...
                  <div class="mb-10">
                    <button
                      type="submit"
                      class="border-primary w-full cursor-pointer rounded-md border bg-[#a77555] py-3 px-5 text-base text-white transition hover:bg-opacity-90"
                    >
                      Register
                    </button>
