  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `${baseURL}/api/v1/products/createProduct`,
        formData,
        configCreate
      );
...
export const fetchFreeProd = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axios.get(
        `${baseURL}/api/v1/products/fetchFreeProducts`,
        config
      );
      return data;
    } catch (error) {
...
export const fetchPaidProd = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axios.get(
        `${baseURL}/api/v1/products/fetchPaidProducts`,
        config
      );
      return data;
    } catch (error) {
...
export const fetchTiktok = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axios.get(
        `${baseURL}/api/v1/products/fetchTiktokProducts`,
        config
      );
      return data;
    } catch (error) {
...
export const fetchFacebook = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axios.get(
        `${baseURL}/api/v1/products/fetchFacebookProducts`,
        config
      );
      return data;
    } catch (error) {
...
export const fetchGoogle = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axios.get(
        `${baseURL}/api/v1/products/fetchGoogleProducts`,
        config
      );
      return data;
    } catch (error) {
...
export const fetchSingleProd = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axios.get(
        `${baseURL}/api/v1/products/fetchSingleProduct/${payload}`,
        config
      );
      return data;
    } catch (error) {
...
export const singleProdFree = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axios.get(
        `${baseURL}/api/v1/products/fetchSingleProductFree/${payload}`,
        config
      );
      return data;
    } catch (error) {
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.put(
        `${baseURL}/api/v1/products/updateProduct/${id}`,
        sendData,
        config
      );
      return data;
...
export const deleteAllProd = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axios.delete(
        `${baseURL}/api/v1/products/deleteAllProducts`,
        config
      );
      return data;
    } catch (error) {
