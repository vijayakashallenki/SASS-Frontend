...
const CreateProduct = (props) => {
  ...
  const { createRedirect, loading: productLoading } = useSelector(
      ...
      <form className="" onSubmit={formik.handleSubmit}>
          ...
          <Container className="container hover:border-green-400">
            <Dropzone
              ...
              onDrop={(acceptedFiles) => {
                for (let i = 0; i < acceptedFiles.length && i < 7; i++) {
                  formik.setFieldValue(`images${i + 1}`, acceptedFiles[i]);
        ...
        <div className="flex justify-center m-4">
          ...
          <div className="w-[10%] flex justify-center">
            <div className="w-[80px] border-4 border-blue-500 border-b-0">
